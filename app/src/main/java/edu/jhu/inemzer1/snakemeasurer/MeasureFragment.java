...
public class MeasureFragment extends Fragment {
    ...
    public void onResume() {
        ...
        snakePicture = (ImageView) getActivity().findViewById(R.id.snake_image);
        snakePicture.setImageBitmap(BitmapFactory.decodeResource(
                getActivity().getResources(), R.drawable.snake));
        snakePicture.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
    }
